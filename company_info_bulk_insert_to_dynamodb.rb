...
#TABLE_NAME = 'CompanyInfo-l3abir6cjvggzpgakzxe6nsk2m-staging' # dynamodb 테이블이름 - AppSync console 에서 확인 가능합니다.
TABLE_NAME = 'CompanyInfo-nwvmwfuudbd6td2z7ypq537qkm-prod' # dynamodb 테이블이름 - AppSync console 에서 확인 가능합니다.
